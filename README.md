...
1. java -jar .assembly/lawncare-mac-0.5.jar
2. java -jar .assembly/lawncare-m1-0.5.jar
3. java -jar .assembly/lawncare-win-0.5.jar
4. java -jar .assembly/lawncare-linux-0.5.jar
